...
import {
    ...
    STATUS_ADD, STATUS_CONSUME, STATUS_SAPLING_DAMAGE,
    STATUS_SALE_POS, DISPLAY_NAME_VARIETY, IT_STATUS_DISTRIBUTED, IT_STATUS_ADDED,
...
export class NurseryStockMgntComponent implements OnInit {
    ...
    addStockQuantity(value): void {
        if ((this.nurseryStockDetails.date === null)
            ...
            this.subscribeToSaveResponse(
                this.nurseryStockService.update(this.nurseryStock), this.alertTitle
            );
        }
    }

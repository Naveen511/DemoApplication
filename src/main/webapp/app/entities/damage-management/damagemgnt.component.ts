...
import { IDamage, STATUS_SEEDS, STATUS_SEEDLING,
    INVENTORY_STATUS_SEEDS, INVENTORY_STATUS_COVER
} from 'app/shared/model/damage.model';
import { HttpResponse } from '@angular/common/http';
import {
    INurseryStockDetails, STATUS_SAPLING_DAMAGE
...
import {
    INurseryInventoryDetails, STATUS_DAMAGE
...
export class DamagemgntComponent implements OnInit {
    ...
    getSeedDamageList(): void {
        ...
        this.damageService.query({filter: { 'status.equals': STATUS_SEEDS }})
    ...
    getSeedlingDamageList(): void {
        ...
        this.damageService.query({filter: { 'status.equals': STATUS_SEEDLING }})
        .subscribe((res: HttpResponse<IDamage[]>) => {
